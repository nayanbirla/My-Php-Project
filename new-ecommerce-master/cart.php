...
<html class="no-js" lang="en">
  <head>
    ...
    <title>Shopping Cart || proChamp</title>
      ...
      <div class="large-12">
        ...
        if (isset($_SESSION["cart"])) {
          ...
          foreach ($_SESSION["cart"] as $product_id => $quantity) {
            $result = $mysqli->query(
              "SELECT product_name, product_desc, qty, price FROM products WHERE id = " .
                $product_id
            );
            ...
            if ($result) {
              while ($obj = $result->fetch_object()) {
                ...
                echo "<td>" .
                  $quantity .
                  '&nbsp;<a class="button [secondary success alert]" style="padding:5px;" href="update-cart.php?action=add&id=' .
                  $product_id .
                  '">+</a>&nbsp;<a class="button alert" style="padding:5px;" href="update-cart.php?action=remove&id=' .
                  $product_id .
                  '">-</a></td>';
                echo "<td>" . $cost . "</td>";
                echo "</tr>";
