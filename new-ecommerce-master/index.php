...
<html class="no-js" lang="en">
  ...
  <nav class="top-bar" data-topbar role="navigation">
    ...
    <img data-interchange="[images/bolt-retina.jpg, (retina)], [images/back.jpg, (large)], [images/bolt-mobile.jpg, (mobile)], [images/back.jpg, (medium)]">
    <noscript><img src="images/back.jpg"></noscript>
    ...
    <ul class="small-12 small-block-grid-2 medium-block-grid-3 large-block-grid-3" data-equalizer>
        ...
        if ($result) {
          while ($obj = $result->fetch_object()) {
            ...
            if ($obj->qty > 0) {
              echo '<p class="text-center" ><a href="update-cart.php?action=add&id=' .
                $obj->id .
                '"><input class="button radius primary" type="submit" value="Add To Cart"  /></a></p>';
            } else {
              echo "Out Of Stock!";
            }
            echo "</div>";
